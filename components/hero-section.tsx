    ...
    >
      ...
      <div className={`max-w-7xl w-full relative z-20 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
        <div className="text-center space-y-8 sm:space-y-12 md:space-y-16 relative">
          ...
          <div
            className="pt-4 animate-fade-in flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6"
          ...
          >
            ...
            >
              <Download className="w-4 h-4 sm:w-5 sm:h-5 relative z-10 shrink-0" aria-hidden />
